//getInnerMostLoopID.cpp is designed to get the parent loop id and parent function name of a certain instruction.
...
namespace {
  ...
  //  }
    ...
    //  }          
      ...
      return (ICmpPointerToString(icmp));
    }  
    ...
    bool runOnFunction(Function &F) override {
      ...
      for(int i = initialIdx; i < global_loop_id; i++){
          ...
          j[loopIndex]["CmpInst"] = getLatchCMP(itr->first);
